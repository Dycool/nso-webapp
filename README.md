<p align="center">
  <img src="favicon.svg" alt="CoralWeb icon" width="128" height="128">
</p>

# CoralWeb

**A modern, responsive, and feature-complete unofficial Web Application client for Nintendo Switch Online (Coral).**
...
The project's original source code is available under the [MIT License](LICENSE). Third-party open-source notices are available within the app settings.