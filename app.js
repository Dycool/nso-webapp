...
(() => {
    ...
    // res/xml/locales_config.xml; every native-app string below is extracted verbatim
    // from the APK language split resources. APK strings always take priority. Web-port-only
    // copy may use separately maintained translations when no Nintendo resource exists.
